  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float4 col_1;
          float tmpvar_2;
          tmpvar_2 = lerp(-0.166, 1, _Cutoff);
          col_1 = (tex2D(_MainTex, in_f.xlv_TEXCOORD0) * in_f.xlv_COLOR);
          float4 tmpvar_3;
          tmpvar_3 = tex2D(_MaskTex, in_f.xlv_TEXCOORD0);
          if((tmpvar_3.x>=tmpvar_2))
          {
              float tmpvar_4;
              tmpvar_4 = (1 - ((tmpvar_3.x - tmpvar_2) * 6));
              col_1.w = tmpvar_4;
          }
          out_f.color = col_1;
          return out_f;
