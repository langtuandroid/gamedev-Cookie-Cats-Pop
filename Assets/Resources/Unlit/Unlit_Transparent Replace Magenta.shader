Shader "Unlit/Transparent Replace Magenta"
{
  Properties
  {
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float tmpvar_4;
          tmpvar_4 = abs((tmpvar_3.x - tmpvar_3.z));
          float tmpvar_5;
          float tmpvar_6;
          tmpvar_6 = clamp((((1 - tmpvar_4) * (tmpvar_3.x - tmpvar_3.y)) * _SaturationFactor), 0, 1);
          tmpvar_5 = tmpvar_6;
          float3 tmpvar_7;
          tmpvar_7 = (in_f.xlv_COLOR.xyz * tmpvar_3.x);
          tinted_2 = tmpvar_7;
          float3 tmpvar_8;
          tmpvar_8 = lerp(tmpvar_3.xyz, tinted_2, float3(tmpvar_5, tmpvar_5, tmpvar_5));
          float4 tmpvar_9;
          tmpvar_9.xyz = float3(tmpvar_8);
          tmpvar_9.w = (tmpvar_3.w * in_f.xlv_COLOR.w);
          tmpvar_1 = tmpvar_9;
