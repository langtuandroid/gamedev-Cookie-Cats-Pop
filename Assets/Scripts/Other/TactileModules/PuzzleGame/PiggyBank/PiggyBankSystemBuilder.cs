...
namespace TactileModules.PuzzleGame.PiggyBank
{
	...
	{
		public static PiggyBankSystem Build(MapFacade mapFacade, MainProgressionManager mainProgression, IMapProvider mapProvider, IItemsProvider itemsProvider, IPiggyBankProvider provider, UserSettingsManager userSettingsManager, ConfigurationManager configurationManager,  MapPopupManager mapPopupManager)
		{
			...
			PiggyBankControllerFactory controllerFactory = new PiggyBankControllerFactory(mainProgression, provider, piggyBankProgression, rewards);
