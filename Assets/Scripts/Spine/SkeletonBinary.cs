...
namespace Spine
{
    public class SkeletonBinary
    {
        ...
        private void GetVersion(string version, out int major, out int minor, out int revision)
        {
            major = 0;
            minor = 0;
            revision = 0;
            ...
            if (array.Length > 2)
            {
                int.TryParse(array[2], out revision);
            }
            else
            {
                revision = 0;
        ...
        public SkeletonData ReadSkeletonData(Stream input)
        {
            ...
            if (skeletonData.version != null)
            {
                ...
                int num2;
                int num3;
                this.GetVersion(skeletonData.version, out num, out num2, out num3);
                if (num == 3 && num2 < 4)
                {
                    return new SkeletonLeagacyLoader(this.attachmentLoader, scale).ReadSkeletonData(input, skeletonData.hash, skeletonData.version, this.Scale);
                }
            }
            ...
            while (num17 < count)
            {
                SkeletonJson.LinkedMesh linkedMesh = this.linkedMeshes[num17];
            ...
            int num20 = 0;
            int num21 = SkeletonBinary.ReadVarint(input, true);
            while (num20 < num21)
            {
                ...
                case 0:
                    {
                        ...
                        regionAttachment.r = (float)(((long)num5 & (long)((ulong)0xFF000000)) >> 24) / 255f;
                ...
                case 2:
                    {
                        ...
                        meshAttachment.r = (float)(((long)num7 & (long)((ulong)0xFF000000)) >> 24) / 255f;
                ...
                case 3:
                    {
                        ...
                        meshAttachment2.r = (float)(((long)num12 & (long)((ulong)0xFF000000)) >> 24) / 255f;
