...
namespace Spine.Unity
{
	...
	public class BoneFollower : MonoBehaviour
	{
		...
		public void LateUpdate()
		{
			...
			{
				num = ((!(this.bone.skeleton.flipX ^ this.bone.skeleton.flipY)) ? 1f : -1f);
				transform.localScale = new Vector3(1f, num, 1f);
			}
			if (this.followBoneScale)
			{
				transform.localScale = new Vector3(this.bone.scaleX, this.bone.scaleY * num, 1f);
			}
		}
